...
public class AltKeyBug {
    ...
    private static boolean rightAltReleased = false;
        ...
        try {
            ...
            comp.addKeyListener(new KeyListener() {
                ...
                @Override public void keyPressed(KeyEvent e) {
                    ...
                    System.out.println("rightAltPressed: " + rightAltPressed);
                    if (rightAltPressed) {
                        if (e.getKeyCode() != KeyEvent.VK_ALT_GRAPH && e.getModifiersEx() != (KeyEvent.ALT_GRAPH_DOWN_MASK | KeyEvent.ALT_DOWN_MASK)) {
                            throwException = true;
                            errorString = "Expected keycode for right Alt key, but received: " + e.getKeyCode();
                        }
                    } else {
                        if (e.getKeyCode() != KeyEvent.VK_ALT && e.getModifiersEx() != KeyEvent.ALT_DOWN_MASK) {
                            throwException = true;
                            errorString = "Expected keycode for left alt key, but received: " + e.getKeyCode();
                        }
                    }
                }
                ...
                @Override public void keyReleased(KeyEvent e) {
                    ...
                    if (rightAltReleased) {
                        if (e.getKeyCode() != KeyEvent.VK_ALT_GRAPH && e.getModifiersEx() != 0) {
                            throwException = true;
                            errorString = "Expected keycode for right Alt key, but received: " + e.getKeyCode();
                        }
                    } else {
                        if (e.getKeyCode() != KeyEvent.VK_ALT && e.getModifiersEx() != KeyEvent.ALT_GRAPH_DOWN_MASK) {
                            throwException = true;
                            errorString = "Expected keycode for left alt key, but received: " + e.getKeyCode();
                        }
                    }
