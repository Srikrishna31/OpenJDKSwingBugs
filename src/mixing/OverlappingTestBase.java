 ...
 * <p>Current AWT component should be added to the tested UI by {@link OverlappingTestBase#propagateAWTControls(Container) ()}.
 ...
 * <p> Validation of component being overlayed should be tested by {@link OverlappingTestBase#clickAndBlink(Robot, Point) }
...
public abstract class OverlappingTestBase {
     ...
     * @see OverlappingTestBase#clickAndBlink(Robot, Point, boolean)
     */
...
//                System.err.println(eframe.getSize());
    ...
    /**
     * Default shift for {@link OverlappingTestBase#clickAndBlink(Robot, Point) }
     */
    protected static Point shift = new Point(16, 16);

    /**
     * Verifies point using specified AWT Robot. Supposes <code>defaultShift == true</code> for {@link OverlappingTestBase#clickAndBlink(Robot, Point, boolean) }.
    ...
    private static boolean isValidForPixelCheck(Component component) {
        if ((component instanceof Scrollbar) || isMac && (component instanceof Button)) {
            return false;
        }
        return true;
    }
     ...
     *
     * @see {@link OverlappingTestBase#propagateAWTControls(Container) } for instructions about adding tested AWT control to UI
     */
